...
function BrowserHistory() {
    ...
    const OpenaiFetchAPI = () => {
        ...
        var historyCatCount = new Array(0,0,0);
        var url = "https://api.openai.com/v1/engines/text-davinci-003/completions";
        var bearer = 'Bearer ' + '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'
        ...
        for (let i = 0; i < websiteList.length; i++) {
            ...
            fetch(url, {
                ...
                //   websiteCategory[i] = (body["choices"][0]["text"])
                ...
                console.log('web category', historyCat)
        ...
        // console.log('history cat', historyCat);
